...
public partial class CUsersDanliSourceReposProjectmanagementProjectmanagementDalDatabaseDatabaseMdfContext : DbContext
{
    public CUsersDanliSourceReposProjectmanagementProjectmanagementDalDatabaseDatabaseMdfContext()
    {
    }

    public CUsersDanliSourceReposProjectmanagementProjectmanagementDalDatabaseDatabaseMdfContext(DbContextOptions<CUsersDanliSourceReposProjectmanagementProjectmanagementDalDatabaseDatabaseMdfContext> options)
        : base(options)
    {
    }
